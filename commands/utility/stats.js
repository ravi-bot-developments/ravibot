...
export default class StatsCommand extends Command {
    ...
    public exec(message: Message) {
        ...
        const embed: Partial<MessageEmbed> = {
            ...
            color: 16316671,
            fields: [
                { inline: false, name: 'Developer', value: '! kim jaehyun.#87751' },
                { inline: false, name: 'Source', value: `[${ botName }${ botName.toLowerCase().endsWith('s') ? '\'' : '\'s' } code](https://github.com/Jeffreyz1129/ravi)` },
                {
                    inline: false,
                    name: 'Random stuff',
                    value: [
